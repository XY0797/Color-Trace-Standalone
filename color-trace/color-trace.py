...
# 外部程序的路径
pngquant_命令 = '"' + script_directory + '\\third-party-cmd\\pngquant\\pngquant.exe"'

# pngnq已经无法在现代计算机运行
# pngnq_路径 = '"' + script_directory + '\\third-party-cmd\\pngnq\\pngnq.exe"'

ImageMagick_convert_命令 = '"' + script_directory + '\\third-party-cmd\\imagemagick\\magick.exe" convert'
ImageMagick_identify_命令 = '"' + script_directory + '\\third-party-cmd\\imagemagick\\magick.exe" identify'
potrace_命令 = '"' + script_directory + '\\third-party-cmd\\potrace\\potrace.exe"'
potrace_选项 = ''
